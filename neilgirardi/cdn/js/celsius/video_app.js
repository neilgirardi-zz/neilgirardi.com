...
/**
* positions video player in dead center of the X-axis of the screen and 20px below the center of the Y-axis
*/

function positionVideoPlayer() {
	// determine left position of #formBox
	var windowWidth = $(window).width();
	var Lposition = (windowWidth - 425) / 2;
	var leftPosition = Lposition + "px";
	// determine the top position of the #formBox
	var windowHeight = $(window).height();
	var Tposition = (windowHeight - 350) / 2 + 40;
	var topPosition = Tposition + "px";
	// set left position of #formBox
	$('#videoPlayer').css("left", leftPosition);
	// set the top position of the #formBox
	$('#videoPlayer').css("top", topPosition);
}

/**
* hides the video player and shows the thumbnails
* this is used for the close video link
*/

function hideVideo(){
	$('#searchResultsVideoColumn').fadeOut(500);
	$('#searchResultsListColumn').show();
	$('#searchBoxBottom').show();
	$('#nav-info').show();
}

/**
* shows the video player and hides the thumbnails
* this is called by the present video function
*/

function showVideo(){
	$('#searchResultsVideoColumn').show();
	$('#searchResultsListColumn').hide();
	$('#searchBoxBottom').hide();
	$('#nav-info').hide();
}

/**
* darkens screen during viewing of a video clip
*/
...
$(document).ready(function(){
	ytVideoApp.listVideos('search_all', '', 1);
});
...
/*
* END OF YOU TUBE VARIBALES
*/



/**
* START YOU TUBE FUNCTIONS
*/
...
ytVideoApp.sendRequest = function(filePath, params, resultDivName) {
  ...
  xmlhr.onreadystatechange = function() {
    ...
    if (xmlhr.readyState == 1) {
      resultDiv.innerHTML = '<span class="progress">progress...</span><p class="progressBar"><span><em style="left:160px"></span></p>'; 
...
ytVideoApp.presentVideo = function(videoId, updateThumbnail) {
	...
	var filePath = 'http://neilgirardi.com/portfolio/common_elements/portfolio_sites/celsius/ZendGdata-1.11.0/operations.php';
